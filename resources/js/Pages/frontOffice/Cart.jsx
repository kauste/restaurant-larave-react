...
function Cart(props){
    ...
    return(
        <Authenticated auth={props.auth} message={message} modalInfo={modalInfo} setModalInfo={setModalInfo} comfirmModalInfo={comfirmModalInfo} setComfirmModalInfo={setComfirmModalInfo} cart={cart} setCart={setCart}>
                        <Head title="Cart"/>
            <div className="py-12 cart">
                <div className="max-w-7xl mx-auto sm:px-0 ">
                    <div className="container for--zoom">
                        ...
                        {
                            cart.map((restaurant, index)=> <CartRestaurant key={index} deliveryPrice={props.deliveryPrice} asset={props.asset} restaurant={restaurant} setModalInfo={setModalInfo} setComfirmModalInfo={setComfirmModalInfo} setCart={setCart} cart={cart} setMessage={setMessage}></CartRestaurant>)
                        }
                    </div>
                </div>
            </div>
